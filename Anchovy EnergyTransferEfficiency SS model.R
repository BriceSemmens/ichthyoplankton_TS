...
trans.Eff_SS_MAP<- fitted
trans.Eff_SS_lower95<- lower95
trans.Eff_SS_upper95<- upper95

trans.Eff.SS.estimates<-cbind(Year,trans.Eff_SS_MAP,trans.Eff_SS_lower95,trans.Eff_SS_upper95)
write.csv(trans.Eff.SS.estimates, file = "trans.Eff.SS.estimates.csv")
