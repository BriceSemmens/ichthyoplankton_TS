...
graph.ssm<-function(N.est,N.yr,weights,years,max.yr, min.yr){
  ...
  plot(0,0,ylim=c(m1,m2),xlim=c(0.5,N.yr),ylab="Small Cop",xlab="year",las=1,col="black",type="l",lwd=2,frame=FALSE,axes=FALSE)
  axis(2,las=1)
...
write.csv(Cop.small.SS.estimates, file = "Cop.small.SS.estimates.csv")
